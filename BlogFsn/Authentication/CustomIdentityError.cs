    ...
    public class CustomIdentityError : IdentityErrorDescriber
    {
        public override IdentityError DuplicateEmail(string email)
        {
            return new IdentityError()
            {
                ...
                Description = $"ایمیل قبلا توسط شخص دیگری انتخاب شده است"
            };
        }
        ...
        public override IdentityError DuplicateUserName(string userName)
        {
            return new IdentityError()
            {
                ...
                Description = $"نام کاربری  قبلا توسط شخص دیگری انتخاب شده است"
            };
        }
        ...
        public override IdentityError InvalidEmail(string email)
        {
            return new IdentityError()
            {
                ...
                Description = $"ایمیل  ، یک ایمیل معتبر نیست"
            };
        }
        ...
        public override IdentityError DuplicateRoleName(string role)
        {
            return new IdentityError()
            {
                ...
                Description = $"مقام  قبلا ثبت شده است"
            };
        }
        ...
        public override IdentityError InvalidUserName(string userName)
        {
            return new IdentityError()
            {
                ...
                Description = $"نام کاربری  معتبر نیست، نام کاربری فقط میتواند دارای حروف یا عدد باشد"
            };
        }
        public override IdentityError UserNotInRole(string role)
        {
            return new IdentityError()
            {
                ...
                Description = $"کاربر در مقام  نیست"
            };
        }
